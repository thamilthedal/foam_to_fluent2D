...
def get_points(CWD: str)->pd.DataFrame:
...
def get_faces(CWD: str)->list:
    ...
    # neighbour_data
    neighbour_file = f'{CWD}/constant/polyMesh/neighbour'
    ...
    # owner_data
    owner_file = f'{CWD}/constant/polyMesh/owner'
...
def get_boundary_info(CWD: str)->dict:
    boundary_file = f"{CWD}/constant/polyMesh/boundary"
...
def get_n_nodes(CWD: str)->int:
    neighbour = ch.read_file(f"{CWD}/constant/polyMesh/neighbour")
